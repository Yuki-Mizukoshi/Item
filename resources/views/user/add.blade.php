                ...
                <form method="POST" action="#">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="必須入力">
                        </div>


                        <div class="form-group">
                            <label for="price">メールアドレス</label>
                            <input type="email" class="form-control" id="email" name="email" placeholder="必須入力">
                        </div>

                        <div class="form-group">
                            <label for="stock">パスワード</label>
